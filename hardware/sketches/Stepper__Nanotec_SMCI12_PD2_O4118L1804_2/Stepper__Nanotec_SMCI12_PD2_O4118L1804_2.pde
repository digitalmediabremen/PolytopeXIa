...
void setup() {
    ...
    String mPortName = "/dev/tty.usbserial-0001";//Serial.list()[0];
...
/*
    sendCommand(compileCommand("Z1|"));
    delay(200);
    sendCommand(compileCommand(">800u"));
    sendCommand(compileCommand("Z1|"));
    delay(200);
*/

    /* --- */
    //sendCommand(compileCommand(MOTOR_CMD_STATUS));
    //delay(1000);
    //sendCommand(compileCommand(MOTOR_CMD_FIRMWARE));
    //delay(1000);
    /* --- */
    //sendCommand(compileCommand("E"));
    //delay(100);
    //for (int i=1; i < 33; i++) {
    //    sendCommand(compileCommand("Z" + i + "E"));
    //    delay(100);
    //}
