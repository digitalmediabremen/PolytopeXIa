...
static class CommandController {
  ...
  public Response sendCommand(String commandString)  throws CommandTimedOutException {

    commandResponse = null;
    Command command = new Command(0, commandString);
    return sendCommand(command, RETRY_COUNT);
  }

  public Response sendCommand(int motorId, String commandString)  throws CommandTimedOutException {
    commandResponse = null;
    Command command = new Command(motorId, commandString);
    return sendCommand(command, RETRY_COUNT);
  }

  public Response sendCommand(int motorId, String commandString, int value) throws CommandTimedOutException {
    commandResponse = null;
    Command command = new Command(motorId, commandString, value);
    return sendCommand(command, RETRY_COUNT);
  }
  
  //public Response sendCommand(int[] motorIds, String commandString, int[] values) {
