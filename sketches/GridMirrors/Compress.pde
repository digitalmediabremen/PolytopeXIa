...
public static class LitheString {
  ...
  public static byte[] z2UTF8(byte[] input) {
    ArrayList<UTF8Char> listChars = new ArrayList<>();
    ...
    ArrayList<Map.Entry<UTF8Char, String>> listHuff = new ArrayList<>();
   ...
   * @return
   */
  private static BitWriter innerZ2(ArrayList<UTF8Char> listChars, int spareBits, Map<UTF8Char, String> huff, ArrayList<Map.Entry<UTF8Char, String>> listHuff) {
    BitWriter output = new BitWriter();
    output.write01("1010");
